<template>
  <el-dialog
    top="20vh"
    width="588px"
    :title="params.mode === 'create' ? '新增文件类型' : '编辑文件类型'"
    ...
    opened: function() {
      ...
      if (that.params.id > 0) {
        that.form = {
          ...that.params.detail,
          parentId:
            that.params.detail.parentId > 0 ? that.params.parentIdArr : [-1],
