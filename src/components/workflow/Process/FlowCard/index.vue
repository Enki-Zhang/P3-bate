            ...
            <section class={classList.join(' ')} onClick={this.eventLancher.bind(ctx, "edit", conf)}>
                <header class="header">
                    <div class="title-box" style="height: 100%;width:190px;">
                        {isApprNode && (
                            <i class="iconfont el-icon-s-check"
                               style="font-size:12px;color:white;margin-right:4px;"></i>
                        )}
                        {isCopyNode && (
                        ...
                        {!isStartNode && (
                            <input vModel_trim={conf.properties.title} class="title-input" style="margin-top:3px;"
                                   onClick={stopPro}/>
                        )}
                    </div>
                    <div class="actions" style="margin-right:4px;">
                        <i class="el-icon-close icon"
                           onClick={this.eventLancher.bind(ctx, "deleteNode", conf, ctx.data)}></i>
                    </div>
                </header>
                <div class="body">
